-- BEAST MODE — Migração 025: motor reconhece "só corrida" e não força um treino
-- de ginásio quando não há ginásio nem casa como local de treino. (aplicada 2026-08-02)
