-- BEAST MODE — Migração 033: motor deixa de escolher sempre o mesmo exercício para o
-- mesmo padrão/equipamento/nível. Rotaciona pelo nº de planos anteriores do cliente —
-- mesma lógica já usada para o "Dia de Estímulo", agora aplicada também aos exercícios.
-- (aplicada 2026-08-11)
  ...
  if v_so_corrida then
    ...
    for i in 1 .. array_length(v_formatos_semana, 1) loop
      ...
      v_dias := v_dias || jsonb_build_object(
        'nome', 'Corrida ' || chr(64 + i), 'tipo', 'corrida',
